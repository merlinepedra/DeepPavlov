...
class TorchPolicyNetwork(TorchModel):
    # todo implement all the features of LRScheduledTFModel because it previously was the parent of this thing
    ...
    def __init__(self, network_params_passed: PolicyNetworkParams,
        ...
        # could be passed to Super:
        # LRScheduledTFModel:
        #     * [implemented but probs other name] optimizer: str = 'AdamOptimizer',
        #     * [not implemented] clip_norm: float = None,
        #     * [not implemented] momentum: float = None,
        # LRScheduledModel:
        #     * [not implemented] learning_rate: Union[None, float, Tuple[float, float]] = None,
        #     * [not implemented] learning_rate_decay: Union[DType, Tuple[DType, float]] = DecayType.NO,
        #     * [? lr_decay_every_n_epochs] learning_rate_decay_epochs: int = 0,
        #     * [? ] learning_rate_decay_batches: int = 0,
        #     * [is implemented] learning_rate_drop_div: float = 2.0,
        #     * [is implemented] learning_rate_drop_patience: Optional[int] = None,
        #     * [not implemented] momentum: Union[None, float, Tuple[float, float]] = None,
        #     * [not implemented] momentum_decay: Union[DType, Tuple[DType, float]] = DecayType.NO,
        #     * [not implemented] momentum_decay_epochs: int = 0,
        #     * [not implemented] momentum_decay_batches: int = 0,
        #     * [not implemented] fit_batch_size: Union[None, int, str] = None,
        #     * [not implemented] fit_learning_rate: Tuple[float, float] = (1e-7, 100),
        #     * [not implemented] fit_learning_rate_div: float = 10.,
        #     * [not implemented] fit_beta: float = 0.98,
        #     * [not implemented] fit_min_batches: int = 10,
        #     * [not implemented] fit_max_batches: Optional[int] = None,
        #     * [not implemented] load_before_drop: bool = False,
        # TFModel:
        #     * NNModel () -- is implemented
