# coding=utf-8
# Copyright 2018 Mesh TensorFlow authors, T5 Authors, HuggingFace Inc. team, DeepPavlov team.
#
...
T5 code base is from Transformers 4.0.1

DeepPavlov team added implementaion of memory tokens to T5 model.
"""
...
class T5Stack(T5PreTrainedModel):
    def __init__(self, config, embed_tokens=None, memory_tokens=None):
        ...
        # memory size: number of memory tokens
