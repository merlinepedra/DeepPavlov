...
autodoc_mock_imports = ['aiml', 'bert_dp', 'bs4', 'datasets', 'faiss', 'fastText', 'fasttext', 'gensim', 'hdt', 'kenlm',
                        'librosa', 'lxml', 'nemo', 'nemo_asr', 'nemo_tts', 'nltk', 'rapidfuzz', 'rasa',
                        'russian_tagsets', 'sacremoses', 'sortedcontainers', 'spacy', 'tensorflow', 'tensorflow_hub',
                        'torch', 'transformers', 'udapi', 'ufal_udpipe', 'whapi']
